...
CREATE TABLE dashboards (
    ...
    CONSTRAINT valid_dashboard_type_on_dashboards CHECK (((((((provider)::text = 'slack'::text) AND ((((((((dashboard_type)::text = 'bots-installed'::text) OR ((dashboard_type)::text = 'bots-uninstalled'::text)) OR ((dashboard_type)::text = 'new-users'::text)) OR ((dashboard_type)::text = 'messages'::text)) OR ((dashboard_type)::text = 'messages-to-bot'::text)) OR ((dashboard_type)::text = 'messages-from-bot'::text)) OR ((dashboard_type)::text = 'custom'::text))) OR (((provider)::text = 'facebook'::text) AND (((((((((((dashboard_type)::text = 'new-users'::text) OR ((dashboard_type)::text = 'messages-to-bot'::text)) OR ((dashboard_type)::text = 'messages-from-bot'::text)) OR ((dashboard_type)::text = 'user-actions'::text)) OR ((dashboard_type)::text = 'get-started'::text)) OR ((dashboard_type)::text = 'images-sent'::text)) OR ((dashboard_type)::text = 'location-sent'::text)) OR ((dashboard_type)::text = 'audio-uploaded'::text)) OR ((dashboard_type)::text = 'files-uploaded'::text)) OR ((dashboard_type)::text = 'custom'::text)))) OR (((provider)::text = 'kik'::text) AND (((((dashboard_type)::text = 'new-users'::text) OR ((dashboard_type)::text = 'messages-to-bot'::text)) OR ((dashboard_type)::text = 'messages-from-bot'::text)) OR ((dashboard_type)::text = 'custom'::text)))) OR ((provider)::text = 'telegram'::text))),
...
CREATE TABLE queries (
    ...
    CONSTRAINT validate_method CHECK (((((((((provider)::text = 'slack'::text) AND ((((field)::text = 'nickname'::text) OR ((field)::text = 'email'::text)) OR ((field)::text = 'full_name'::text))) AND (((method)::text = 'equals_to'::text) OR ((method)::text = 'contains'::text))) OR (((((provider)::text = 'facebook'::text) OR ((provider)::text = 'kik'::text)) AND (((field)::text = 'first_name'::text) OR ((field)::text = 'last_name'::text))) AND (((method)::text = 'equals_to'::text) OR ((method)::text = 'contains'::text)))) OR ((((provider)::text = 'facebook'::text) AND ((field)::text = 'gender'::text)) AND (((method)::text = 'equals_to'::text) OR ((method)::text = 'contains'::text)))) OR ((((((provider)::text = 'slack'::text) OR ((provider)::text = 'facebook'::text)) OR ((provider)::text = 'kik'::text)) AND ((field)::text = 'interaction_count'::text)) AND (((((method)::text = 'equals_to'::text) OR ((method)::text = 'between'::text)) OR ((method)::text = 'greater_than'::text)) OR ((method)::text = 'lesser_than'::text)))) OR ((((((provider)::text = 'slack'::text) OR ((provider)::text = 'facebook'::text)) OR ((provider)::text = 'kik'::text)) AND (((field)::text = 'interacted_at'::text) OR ((field)::text = 'user_created_at'::text))) AND ((((method)::text = 'between'::text) OR ((method)::text = 'greater_than'::text)) OR ((method)::text = 'lesser_than'::text)))))
);
