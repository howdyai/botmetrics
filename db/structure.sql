...
--
-- Name: append_to_rolledup_events_queue_on_update(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION append_to_rolledup_events_queue_on_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  __bot_id int;
