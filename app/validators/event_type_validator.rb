class EventTypeValidator < ActiveModel::Validator
  ...
  KIK_EVENT_TYPES = %w(message message:image-uploaded message:video-uploaded message:link-uploaded message:scanned-data message:sticker-uploaded message:friend-picker-chosen message:is-typing message:start-chatting)
